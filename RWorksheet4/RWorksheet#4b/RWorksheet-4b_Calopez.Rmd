...
```{r}
accessData <- read.csv("df_shoes.csv")
head(accessData)
...
png("totalPlot.png")
dev.off()
knitr::include_graphics("/cloud/project/RWorksheet4/RWorksheet#4b/totalPlot.png")
...
dev.off()
knitr::include_graphics("/cloud/project/RWorksheet4/RWorksheet#4b/BlackN_whitePlot.png")
